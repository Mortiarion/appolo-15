<script lang="ts">
	import Instagram_Icon from '$lib/icons/Instagram_Icon.svelte';
	import LogoIcon from '$lib/icons/Logo_Icon.svelte';
	import Telegram_Icon from '$lib/icons/Telegram_Icon.svelte';
